...
class AppDelegate: UIResponder, UIApplicationDelegate
{
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool
    {
        ...
        viewControllerDelegate = ViewControllerDelegate(window: self.window,
                                                application: application,
                                                launchOptions: launchOptions as [UIApplication.LaunchOptionsKey : AnyObject]?)
        
        _navigation = self.viewControllerDelegate.viewController?.makeNavigationViewController()
